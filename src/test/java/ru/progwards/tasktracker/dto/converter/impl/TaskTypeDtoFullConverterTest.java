...
class TaskTypeDtoFullConverterTest {
    ...
    private final TaskTypeDtoFull dtoPreview = getTaskTypeDtoFull();

    @Test
    void toModel() {
        when(converter.toModel(isA(TaskTypeDtoFull.class))).thenReturn(model);
    ...
    void toDto() {
        ...
        TaskTypeDtoFull dto = converter.toDto(model);
