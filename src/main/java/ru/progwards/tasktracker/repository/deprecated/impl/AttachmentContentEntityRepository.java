...
public class AttachmentContentEntityRepository implements Repository<Long, AttachmentContentEntity> {
    ...
    public AttachmentContentEntityRepository() throws IOException {
