...
public class ImportDump {
    public void exec1() {
        try {
            String url = "jdbc:h2:~/tt";
            String username = "";
            String password = "";
            Class.forName("org.h2.Driver").getDeclaredConstructor().newInstance();
            String sqlCommand = "\n" + "" +
                    "INSERT INTO task_attachment_content (id, data) select 1000000, null  where not exists (select id from task_attachment_content where id = 1000000);\n" +
                    "INSERT INTO task_attachment_content (id, data) select 1000001, null  where not exists (select id from task_attachment_content where id = 1000001);\n" +
                    "INSERT INTO task_attachment_content (id, data) select 1000002, null  where not exists (select id from task_attachment_content where id = 1000002);\n" +
                    "\n" +
                    ...
                    "\n" +
                    "INSERT INTO workflow (id, name, pattern, start_status_id) select 1000000, 'nameWorkFlow1', true, null  where not exists (select id from workflow where id = 1000000);\n" +
                    "INSERT INTO workflow (id, name, pattern, start_status_id) select 1000001, 'nameWorkFlow2', true, null  where not exists (select id from workflow where id = 1000001);\n" +
                    "INSERT INTO workflow (id, name, pattern, start_status_id) select 1000002, 'nameWorkFlow3', false, null  where not exists (select id from workflow where id = 1000002);\n" +
                    "\n" +
                    ...
                    "\n" +
                    "UPDATE workflow set start_status_id = 1000000 where id = 1000000;\n" +
                    "UPDATE workflow set start_status_id = 1000001 where id = 1000001;\n" +
                    "UPDATE workflow set start_status_id = 1000002 where id = 1000002;\n" +
                    "\n" +
                    ...
                    "\n" +
                    "INSERT INTO task (id, code, created, description, estimation, name, timeLeft, timeSpent, updated, author_id, executor_id, priority_id, project_id, status_id, type_id, deleted) select 1000000, 'code1', CURRENT_TIMESTAMP, 'description1', 1, 'name1', 1, 1, CURRENT_TIMESTAMP, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, false  where not exists (select id from task where id = 1000000);\n" +
                    "INSERT INTO task (id, code, created, description, estimation, name, timeLeft, timeSpent, updated, author_id, executor_id, priority_id, project_id, status_id, type_id, deleted) select 1000001, 'code2', CURRENT_TIMESTAMP, 'description2', 1, 'name2', 1, 1, CURRENT_TIMESTAMP, 1000001, 1000001, 1000001, 1000001, 1000001, 1000001, false  where not exists (select id from task where id = 1000001);\n" +
                    "INSERT INTO task (id, code, created, description, estimation, name, timeLeft, timeSpent, updated, author_id, executor_id, priority_id, project_id, status_id, type_id, deleted) select 1000002, 'code3', CURRENT_TIMESTAMP, 'description3', 1, 'name3', 1, 1, CURRENT_TIMESTAMP, 1000002, 1000002, 1000002, 1000002, 1000002, 1000002, false  where not exists (select id from task where id = 1000002);\n" +
                    "\n" +
                    ...
                    "\n" +
                    "INSERT INTO related_task (id, attached_task_id, current_task_id, counter_type_id, deleted) select 1000000, 1000000, 1000000, 1000000, false  where not exists (select id from related_task where id = 1000000);\n" +
                    "INSERT INTO related_task (id, attached_task_id, current_task_id, counter_type_id, deleted) select 1000001, 1000001, 1000001, 1000001, false  where not exists (select id from related_task where id = 1000001);\n" +
                    "INSERT INTO related_task (id, attached_task_id, current_task_id, counter_type_id, deleted) select 1000002, 1000002, 1000002, 1000002, false  where not exists (select id from related_task where id = 1000002);\n" +
                    "\n" +
