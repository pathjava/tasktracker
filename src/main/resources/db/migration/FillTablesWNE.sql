...
INSERT INTO task_attachment_content (id, data) select 1000000, 1111111  where not exists (select id from task_attachment_content where id = 1000000);
INSERT INTO task_attachment_content (id, data) select 1000001, 1111111  where not exists (select id from task_attachment_content where id = 1000001);
INSERT INTO task_attachment_content (id, data) select 1000002, 1111111  where not exists (select id from task_attachment_content where id = 1000002);
